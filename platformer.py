...
# игровые переменные
player = Player(0, screen_H-64, 50, 50)
...
blocks.add(
    [Block("tiles", "Grass.png", i * block_size, screen_H - block_size, block_size) for i in range(4)],

    [Block("tiles", "Dirt.png", 6 * block_size, screen_H - block_size * 2, block_size) for i in range(3)],

    [Block("tiles", "Dirt.png", 9 * block_size, screen_H - block_size * 1, block_size)for i in range(4)],

    [Block("tiles", "Dirt.png", 12 * block_size, screen_H - block_size * 4, block_size)for i in range(4)],

    [Block("tiles", "Dirt.png", 9 * block_size, screen_H - block_size *5, block_size)for i in range(4)],

    [Block("tiles", "Dirt.png", 6 * block_size, screen_H - block_size *5, block_size)for i in range(4)],

    [Block("tiles", "Dirt.png", 3 * block_size, screen_H - block_size *6, block_size)for i in range(4)],

    [Block("tiles", "Dirt.png", 6 * block_size, screen_H - block_size *8, block_size)for i in range(4)],

    [Block("tiles", "Grass.png", i * block_size, screen_H - block_size *9, block_size)for i in range(3)]
...
door = Door("tiles", "door.png", block_size * 0, block_size * 0, block_size, block_size * 2)
